...
function StepContent({ step, active }) {
  return (
      ...
      >
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <div className="bg-orange-50 border border-orange-100 rounded-2xl p-5">
            ...
            <p className="text-sm text-slate-600 leading-relaxed mb-3">{step.before.body}</p>
            <div className="inline-flex items-center gap-1.5 bg-orange-100 text-orange-700 text-xs font-semibold px-3 py-1.5 rounded-lg mb-4">
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-2xl p-5">
            ...
            <p className="text-sm text-slate-600 leading-relaxed mb-3">{step.after.body}</p>
            <div className="inline-flex items-center gap-1.5 bg-blue-100 text-blue-700 text-xs font-semibold px-3 py-1.5 rounded-lg mb-4">
...
function StepTabs({ active, onSelect }) {
  return (
...
function SummaryBar() {
  return (
    <div className="mt-6 bg-white border border-slate-200 rounded-2xl px-4 sm:px-6 py-5 flex flex-wrap gap-4 sm:gap-6 items-center">
      <div>
      ...
      <p className="flex-1 min-w-[160px] text-sm text-slate-500 leading-relaxed">
...
function DesktopJourney() {
  ...
  return (
    <section
      ...
      className="relative"
    >
      <div className="sticky top-0 h-screen pt-16 overflow-hidden bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full py-10 flex flex-col">
          ...
          {/* Read-only tab indicators (scroll drives active) */}
...
// ── Mobile: click-driven normal section ────────────────────────────────────
    ...
    <section className="py-16 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-slate-950 tracking-tight mb-3">
            It's salary day. Walk through it.
          </h2>
          <p className="text-slate-500 text-sm">
            5 steps. Every one painful without the right system.
          </p>
        </div>

        <StepTabs active={active} onSelect={setActive} />
        <StepContent step={step} active={active} />
        <SummaryBar />
      </div>
    </section>
...
// ── Root: renders the right version per breakpoint ─────────────────────────
...
export default function UserJourneySection() {
  ...
  return isDesktop ? <DesktopJourney /> : <MobileJourney />;
}
